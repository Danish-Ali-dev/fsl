...
<div class="container">
    <h2 class="my-3 bg-danger text-center text-white p-3 heading">Family Super League Batting Rankings</h2>
    <div class="table-responsive">
        <table class="table text-center table-hover fs-5">
            <thead class="bg-danger text-white heading fs-3">
                <tr>
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT * FROM `players` ORDER BY player_runs DESC, player_runs / player_innings DESC, player_id DESC";
